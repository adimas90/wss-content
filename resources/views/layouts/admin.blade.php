            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-header">M. STOK</li>

                        <li class="nav-item">
                            <a href="/info-produk" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Informasi Produk
                        ...
                        <li class="nav-item">
                            <a href="/stok-retail-pusat" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Stok Retail
                                    <span class="right badge badge-danger">New</span>
                        ...
                        <li class="nav-item">
                            <a href="/all-retail-transaction" class="nav-link">
                                <i class="nav-icon fas fa-calendar-alt"></i>
                                <p>
                                    All Retail Transaction
                        ...
                        <li class="nav-item">
                            <a href="/account-admin" class="nav-link">
