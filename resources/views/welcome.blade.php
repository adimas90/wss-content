...
<body class="antialiased">
    <div
        ...
        <nav class="bg-gray-100"
            style="position: fixed; top: 0; width: 100%; z-index: 1000; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
            <div class="navbar" style="display: flex; align-items:center;">
                <h1>W <span style="color: rgb(24, 56, 111);">SS</span></h1>
                {{-- <div class="nav-items">
